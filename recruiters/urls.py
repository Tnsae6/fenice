...
urlpatterns = [
    ...
    path('company_profile/', views.my_company_profile, name='my-company-profile'),
    path('company_profile/edit/', views.edit_profile, name='edit-company-profile'),
    path('company_profile/<slug>', views.profile_view, name='company-profile'),
